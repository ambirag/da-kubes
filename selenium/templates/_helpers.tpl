...
{{/*
Create a default fully qualified app name, for firefoxLarge.
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
*/}}
{{- define "selenium.firefoxLarge.fullname" -}}
{{- printf "%s-selenium-firefox-large" .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
